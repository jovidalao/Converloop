...
export const en = {
  ...
  today: {
    ...
    reviewDrillReason: "{n} item(s) due for review: {items}",
    reviewDrillEmpty: "Nothing due — a quick run still keeps things fresh.",
    dictationTitle: "Dictation",
    dictationReason:
      "{n} word(s) you've missed by ear are waiting to be heard again.",
    dictationFresh: "Train your ear with a few fresh sentences.",
    shadowingTitle: "Read aloud",
    shadowingReason: "Get your mouth moving — shadow a few model sentences.",
    quickfireTitle: "Scenario drills",
    quickfireReason: "Handle a few concrete situations inside one scenario.",
    projectTitle: "Project · {project}",
    projectReason: "Next lesson: {lesson}",
    hint: "This playlist is built from your own records: due review items, words you've missed by ear, and your active project. Any one item is a fine day's work.",
  },
  lessonReview: {
