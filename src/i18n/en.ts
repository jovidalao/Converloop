...
export const en = {
  ...
  coach: {
    ...
    emptyHint:
      "After you send a sentence, this shows the correction for the turn and what the system recorded for you.",
    overview: {
      feedback: "Feedback",
      memory: "Memory",
    ...
    memoryCount: "{n} items",
    noMemoryThisTurn: "Nothing new this turn",
    observationCount: "{n} items",
    noObservations: "No observations",
    proposalCount: "{n} items",
    noProposals: "Nothing to confirm",
    grading: "Grading this turn…",
    noCorrection: "No correction for this turn.",
    originalSentence: "{lang} original",
    corrected: "Corrected",
    moreNatural: "More natural",
    accurate: "Accurate — no changes needed.",
    signal: {
      error: "Marked wrong",
    ...
    memoryEmptyHint:
      "After grading, this shows what was written to learning data this turn.",
    noNewMemory: "No new learning records this turn.",
    noCustomObservations: "No custom observations this turn.",
    ...
    feedbackTitle: "This turn's feedback",
    turnMemoryTitle: "This turn's learning memory",
  ...
  chat: {
    ...
    inputPlaceholderPractice: "Type in your target language… (/ commands)",
