...
export const zh: Messages = {
  ...
  learningAgents: {
    title: "创建专项课",
    description:
      "「专项课」会新开一个对话,使用老师型 system prompt,可以用母语讲解,也可以用目标语言出练习。创建后会出现在「定制化学习」里,在那里开始或编辑。",
    projectTitle: "学习项目",
  ...
  today: {
    ...
    reviewDrillReason: "{n} 个条目到期待复习:{items}",
    reviewDrillEmpty: "暂无到期条目 —— 快速过一轮也能保持手感。",
    dictationTitle: "听写",
    dictationReason: "有 {n} 个听漏过的词,等你再听一遍。",
    dictationFresh: "用几句新句子练练耳朵。",
    shadowingTitle: "跟读",
    shadowingReason: "让嘴巴动起来 —— 跟读几句示范句。",
    quickfireTitle: "情景演练",
    quickfireReason: "在一个场景里应对几个具体情境。",
    projectTitle: "项目 · {project}",
    projectReason: "下一课:{lesson}",
    hint: "这份清单来自你自己的学习记录:到期复习条目、听漏过的词、进行中的项目。完成任意一项,今天就不亏。",
  },
  lessonReview: {
